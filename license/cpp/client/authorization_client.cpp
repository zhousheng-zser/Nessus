...
namespace glasssix::license
{
	...
	private:
		...
		void parse_content(const client_type::connection_ptr& connection, std::string_view content)
		{
	...
	void authorization_client::connect(std::string_view server, std::string_view port) const
	{
