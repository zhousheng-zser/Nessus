...
namespace glasssix::license
{
	...
	public:
		...
		std::vector<authorized_device_record> get_exact_authorized_devices(const exposing::guid& license_id, exposing::param_span<const std::uint8_t> machine_id) const;
