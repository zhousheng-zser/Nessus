...
namespace glasssix
{
	...
	namespace memory
	{
        ...
        struct GPUMemory
        {
            ...
            template <class Any>
            static void allocate(Any** ptr, size_t size, int device, const std::shared_ptr<CUDAStream>& pstream)
            {
			...
			// It's instantiated in test(), train() and time() Excalibur brewing functions
            ...
            private:
                ...
                size_t size_;
                int device_;
                std::shared_ptr<CUDAStream> pstream_;
            ...
            private:
                ...
                DISABLE_COPY_AND_ASSIGN(PinnedBuffer);
            };
        ...
        private:
            struct Manager
        	{
                ...
                bool try_allocate(void** ptr, size_t size, int device, const std::shared_ptr<CUDAStream>& pstream);
