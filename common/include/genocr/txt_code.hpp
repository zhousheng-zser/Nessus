#ifndef _TXT_CODE_OCR_NET_HPP_
#define _TXT_CODE_OCR_NET_HPP_
...
namespace glasssix::exposing::impl
{
    ...
    struct abi<genocr::txt_code>
    {
        ...
        struct type : abi_unknown_object
        {
            virtual std::int32_t G6_ABI_CALL init(
                ...
                abi_in_t<param_string> chardic_directory,
            ...
            virtual std::int32_t G6_ABI_CALL detect(
                ...
                std::int32_t height,
                std::int32_t width, std::int32_t top_five,
                std::int32_t order,
                std::int32_t x,
                std::int32_t y,
                std::int32_t roi_width,
                std::int32_t roi_height,
                abi_out_t<param_vector<genocr::box_info>> result) noexcept = 0;
    ...
    struct interface_vtable<Derived, genocr::txt_code> : interface_vtable_base<Derived, genocr::txt_code>
    {
        virtual std::int32_t G6_ABI_CALL init(
            abi_in_t<param_string> model_directory,
            abi_in_t<param_string> chardic_directory,
            ...
            abi_in_t<exposing::param_hash_map<exposing::param_string, float>> param_map_abi) noexcept override
        {
            return abi_safe_call([&]
                {this->self().init(
                    ...
                    create_from_abi<param_string>(chardic_directory),
        ...
        virtual std::int32_t G6_ABI_CALL detect(
            ...
            std::int32_t height,
            std::int32_t width,
            std::int32_t top_five,
            std::int32_t order,
            std::int32_t x,
            std::int32_t y,
            std::int32_t roi_width,
            std::int32_t roi_height,
            abi_out_t<param_vector<genocr::box_info>> result) noexcept override
        {
            return abi_safe_call([&]
                {
    ...
    template <>
    struct abi_adapter<genocr::txt_code>
    {
        template <typename Derived>
        struct type : enable_self_abi_awareness<Derived, genocr::txt_code>
        {
            void init(
                const param_string& model_directory,
                const param_string& chardic_directory,
                ...
                const exposing::param_hash_map<exposing::param_string, float>& param_map_abi) const
            {
                check_abi_result(this->self_abi().init(
                    ...
                    get_abi(chardic_directory),
                    get_abi(factory_type),
                    get_abi(device),
                    get_abi(param_map_abi)));
            }

            param_vector<genocr::box_info> detect(
            ...
            {
                param_vector<genocr::box_info> result{ nullptr };
...
namespace glasssix::genocr
{
    struct txt_code : exposing::inherits<txt_code>
    {
