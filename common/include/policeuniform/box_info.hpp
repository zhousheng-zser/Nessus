#ifndef _POLICEUNIFORM_BOX_INFO_HPP_
#define _POLICEUNIFORM_BOX_INFO_HPP_
...
{
    template<>
    struct abi<policeuniform::box_info>
    {
        using identity_type = type_identity_interface;

        static constexpr guid id{ "585637C8-AB49-4345-A4FF-2EF06D3EBFAD" };
    ...
    struct interface_vtable<Derived, policeuniform::box_info> : interface_vtable_base<Derived, policeuniform::box_info>
    {
    ...
    template <>
    struct abi_adapter<policeuniform::box_info>
    {
        template <typename Derived>
        struct type : enable_self_abi_awareness<Derived, policeuniform::box_info>
        {
