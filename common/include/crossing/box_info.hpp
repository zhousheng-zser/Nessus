#ifndef _CROSSING_BOX_INFO_HPP_
#define _CROSSING_BOX_INFO_HPP_
...
{
    template<>
    struct abi<crossing::box_info>
    {
        using identity_type = type_identity_interface;

        static constexpr guid id{ "90F69300-1A59-46FA-B4FF-82F5B2631AB9" };
    ...
    struct interface_vtable<Derived, crossing::box_info> : interface_vtable_base<Derived, crossing::box_info>
    {
    ...
    template <>
    struct abi_adapter<crossing::box_info>
    {
        template <typename Derived>
        struct type : enable_self_abi_awareness<Derived, crossing::box_info>
        {
