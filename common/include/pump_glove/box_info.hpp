#ifndef _PUMP_GLOVE_BOX_INFO_HPP_
#define _PUMP_GLOVE_BOX_INFO_HPP_
...
{
    template<>
    struct abi<pump_glove::box_info>
    {
        using identity_type = type_identity_interface;

        static constexpr guid id{ "2ADE5702-BE31-4081-8C39-12A48D19A65E" };
    ...
    struct interface_vtable<Derived, pump_glove::box_info> : interface_vtable_base<Derived, pump_glove::box_info>
    {
    ...
    template <>
    struct abi_adapter<pump_glove::box_info>
    {
        template <typename Derived>
        struct type : enable_self_abi_awareness<Derived, pump_glove::box_info>
        {
