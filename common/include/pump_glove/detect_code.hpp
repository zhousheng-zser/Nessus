#ifndef _PUMP_GLOVE_DETECT_CODE_HPP_
#define _PUMP_GLOVE_DETECT_CODE_HPP_
...
{
    template <>
    struct abi<pump_glove::detect_code>
    {
        using identity_type = type_identity_interface;

        static constexpr guid id{ "F9ADCB9C-9A01-442B-BD9A-E169BF37CB2E" };
        ...
        struct type : abi_unknown_object
        {
            ...
            virtual std::int32_t G6_ABI_CALL detect(
                ...
                abi_out_t<exposing::param_vector<pump_glove::box_info>> result) noexcept = 0;
    ...
    struct interface_vtable<Derived, pump_glove::detect_code> : interface_vtable_base<Derived, pump_glove::detect_code>
    {
        ...
        virtual std::int32_t G6_ABI_CALL detect(abi_in_t<param_span<std::uint8_t>> bitmap,
            ...
            std::int32_t roi_height,
            abi_in_t<exposing::param_hash_map<exposing::param_string, float>> param_map_abi,
            abi_out_t<exposing::param_vector<pump_glove::box_info>> result) noexcept override
        {
            return abi_safe_call([&]
    ...
    template <>
    struct abi_adapter<pump_glove::detect_code>
    {
        template <typename Derived>
        struct type : enable_self_abi_awareness<Derived, pump_glove::detect_code>
        {
            void init(
            ...
            exposing::param_vector<pump_glove::box_info> detect(
            ...
            {
                exposing::param_vector<pump_glove::box_info> result{ nullptr };
