#ifndef _pump_hoisting_BOX_INFO_HPP_
#define _pump_hoisting_BOX_INFO_HPP_
...
{
    template<>
    struct abi<pump_hoisting::box_info>
    {
        using identity_type = type_identity_interface;

        static constexpr guid id{ "6285B2F1-25A5-92F0-9EFB-CA885CF6998A" };
        ...
        struct type : abi_unknown_object
        {
            ...
            virtual std::int32_t G6_ABI_CALL x3(abi_out_t<int> result) noexcept = 0;
            virtual std::int32_t G6_ABI_CALL y3(abi_out_t<int> result) noexcept = 0;
            virtual std::int32_t G6_ABI_CALL x4(abi_out_t<int> result) noexcept = 0;
            virtual std::int32_t G6_ABI_CALL y4(abi_out_t<int> result) noexcept = 0;
    ...
    struct interface_vtable<Derived, pump_hoisting::box_info> : interface_vtable_base<Derived, pump_hoisting::box_info>
    {
        ...
        virtual std::int32_t G6_ABI_CALL y2(abi_out_t<int> result) noexcept override
        {
         ...
         virtual std::int32_t G6_ABI_CALL x3(abi_out_t<int> result) noexcept override
        {
            return abi_safe_call([&]
                { *result = detach_abi(this->self().x3()); });
        }

        virtual std::int32_t G6_ABI_CALL y3(abi_out_t<int> result) noexcept override
        {
            return abi_safe_call([&]
                { *result = detach_abi(this->self().y3()); });
        }

        virtual std::int32_t G6_ABI_CALL x4(abi_out_t<int> result) noexcept override
        {
            return abi_safe_call([&]
                { *result = detach_abi(this->self().x4()); });
        }

        virtual std::int32_t G6_ABI_CALL y4(abi_out_t<int> result) noexcept override
        {
            return abi_safe_call([&]
    ...
    template <>
    struct abi_adapter<pump_hoisting::box_info>
    {
        template <typename Derived>
        struct type : enable_self_abi_awareness<Derived, pump_hoisting::box_info>
        {
