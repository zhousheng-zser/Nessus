#ifndef _EBIKE_BOX_INFO_HPP_
#define _EBIKE_BOX_INFO_HPP_
...
namespace glasssix::exposing::impl
{
    ...
    struct interface_vtable<Derived, ebike::box_info> : interface_vtable_base<Derived, ebike::box_info>
    {
    ...
    template <>
    struct abi_adapter<ebike::box_info>
    {
        template <typename Derived>
        struct type : enable_self_abi_awareness<Derived, ebike::box_info>
        {
