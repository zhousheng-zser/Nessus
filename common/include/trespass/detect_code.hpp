#ifndef _TRESPASS_DETECT_CODE_HPP_
#define _TRESPASS_DETECT_CODE_HPP_
...
{
    template <>
    struct abi<trespass::detect_code>
    {
        using identity_type = type_identity_interface;

        static constexpr guid id{ "{D14F4290-FAEB-4A0F-A616-105FA7953B2C}" };
        ...
        struct type : abi_unknown_object
        {
            ...
            virtual std::int32_t G6_ABI_CALL detect(
                ...
                std::int32_t height,
                std::int32_t width,
                abi_out_t<exposing::param_vector<trespass::box_info>> result) noexcept = 0;
    ...
    struct interface_vtable<Derived, trespass::detect_code> : interface_vtable_base<Derived, trespass::detect_code>
    {
        ...
        virtual std::int32_t G6_ABI_CALL detect(abi_in_t<param_span<std::uint8_t>> bitmap,
            ...
            std::int32_t height,
            std::int32_t width,
            abi_out_t<exposing::param_vector<trespass::box_info>> result) noexcept override
        {
            return abi_safe_call([&]
    ...
    template <>
    struct abi_adapter<trespass::detect_code>
    {
        template <typename Derived>
        struct type : enable_self_abi_awareness<Derived, trespass::detect_code>
        {
            void init(
            ...
            exposing::param_vector<trespass::box_info> detect(
                param_span<std::uint8_t> bitmap,
                std::int32_t channels,
                std::int32_t height,
                std::int32_t width) const
            {
                exposing::param_vector<trespass::box_info> result{ nullptr };
