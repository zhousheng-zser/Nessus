#ifndef _FIRESMOKE_BOX_INFO_HPP_
#define _FIRESMOKE_BOX_INFO_HPP_
...
namespace glasssix::exposing::impl
{
    ...
    struct interface_vtable<Derived, firesmoke::box_info> : interface_vtable_base<Derived, firesmoke::box_info>
    {
    ...
    template <>
    struct abi_adapter<firesmoke::box_info>
    {
        template <typename Derived>
        struct type : enable_self_abi_awareness<Derived, firesmoke::box_info>
        {
