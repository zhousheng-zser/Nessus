#ifndef _PUMP_COVER_PLATE_DETECT_CODE_HPP_
#define _PUMP_COVER_PLATE_DETECT_CODE_HPP_
...
{
    template <>
    struct abi<pump_cover_plate::detect_code>
    {
        using identity_type = type_identity_interface;

        static constexpr guid id{ "95AA49BF-B4A6-4A0C-9F90-DE9C8C6C18AB" };
        ...
        struct type : abi_unknown_object
        {
            ...
            virtual std::int32_t G6_ABI_CALL detect(
                ...
                abi_out_t<pump_cover_plate::box_info> result) noexcept = 0;
    ...
    struct interface_vtable<Derived, pump_cover_plate::detect_code> : interface_vtable_base<Derived, pump_cover_plate::detect_code>
    {
        ...
        virtual std::int32_t G6_ABI_CALL detect(abi_in_t<param_span<std::uint8_t>> bitmap,
            ...
            std::int32_t roi_height,
            abi_in_t<exposing::param_hash_map<exposing::param_string, float>> param_map_abi,
            abi_out_t<pump_cover_plate::box_info> result) noexcept override
        {
            return abi_safe_call([&]
    ...
    template <>
    struct abi_adapter<pump_cover_plate::detect_code>
    {
        template <typename Derived>
        struct type : enable_self_abi_awareness<Derived, pump_cover_plate::detect_code>
        {
            void init(
            ...
            pump_cover_plate::box_info detect(
