#ifndef _CALLSMOKE_BOX_INFO_HPP_
#define _CALLSMOKE_BOX_INFO_HPP_

#include "box_info.hpp"
#include <abi/consumer.hpp>

namespace glasssix::callsmoke
{
    struct detect_code;
}
...
{
    template <>
    struct abi<callsmoke::detect_code>
    {
        ...
        struct type : abi_unknown_object
        {
            ...
            virtual std::int32_t G6_ABI_CALL detect(
                ...
                abi_out_t<exposing::param_vector<callsmoke::box_info>> result) noexcept = 0;
    ...
    struct interface_vtable<Derived, callsmoke::detect_code> : interface_vtable_base<Derived, callsmoke::detect_code>
    {
        ...
        virtual std::int32_t G6_ABI_CALL detect(abi_in_t<param_span<std::uint8_t>> bitmap,
            ...
            std::int32_t width,
            abi_in_t<exposing::param_hash_map<exposing::param_string, float>> param_map_abi,
            abi_out_t<exposing::param_vector<callsmoke::box_info>> result) noexcept override
        {
            return abi_safe_call([&]
    ...
    template <>
    struct abi_adapter<callsmoke::detect_code>
    {
        template <typename Derived>
        struct type : enable_self_abi_awareness<Derived, callsmoke::detect_code>
        {
            void init(
            ...
            exposing::param_vector<callsmoke::box_info> detect(
            ...
            {
                exposing::param_vector<callsmoke::box_info> result{ nullptr };
