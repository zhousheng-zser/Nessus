...
namespace glasssix::exposing::impl
{
    ...
    struct interface_vtable<Derived, callsmoke::box_info> : interface_vtable_base<Derived, callsmoke::box_info>
    {
    ...
    template <>
    struct abi_adapter<callsmoke::box_info>
    {
        template <typename Derived>
        struct type : enable_self_abi_awareness<Derived, callsmoke::box_info>
        {
