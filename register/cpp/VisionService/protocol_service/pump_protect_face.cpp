...
namespace glasssix::exposing::nessus::Service
{
	class S_Pump_Protect_Face :public Service { //Plugin
		...
		static constexpr utf8_string_view MODULE_{ u8"pump_protect_face" };
		static constexpr utf8_string_view NEW_{ u8"pump_protect_face.new" };
		static constexpr utf8_string_view DELETE_{ u8"pump_protect_face.delete" };
		static constexpr utf8_string_view VERSION_{ u8"pump_protect_face.version" };
	...
	REGISTE_SERVICE(S_Pump_Protect_Face) //Plugin
}