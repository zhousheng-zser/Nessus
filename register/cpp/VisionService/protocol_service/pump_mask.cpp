...
#include <iostream>
//
#include <pump_mask/detect_code.hpp>

namespace glasssix::exposing::nessus::Service
{
	class S_Pump_Mask :public Service { //Plugin
		static unknown_object pump_mask_new(const param_hash_map<param_string, unknown_object>& params)
		{
			auto device = unbox<std::int32_t>(params.get_value(u8"device"));
			auto models_directory = unbox<param_string>(params.get_value(u8"models_directory"));

			return vision_service_impl::impl::add_instance(MODULE_, make_exported_interface<pump_mask::detect_code>(models_directory, device));
		}

		static 	unknown_object pump_mask_version(const param_hash_map<param_string, unknown_object>& params)
		{
			auto instance = vision_service_impl::impl::get_instance<pump_mask::detect_code>(params);
		...
		static constexpr utf8_string_view MODULE_{ u8"pump_mask" };
		static constexpr utf8_string_view NEW_{ u8"pump_mask.new" };
		static constexpr utf8_string_view DELETE_{ u8"pump_mask.delete" };
		static constexpr utf8_string_view VERSION_{ u8"pump_mask.version" };
		static constexpr utf8_string_view detect_{ u8"pump_mask.detect" };
	public:
	...
	REGISTE_SERVICE(S_Pump_Mask) //Plugin
}