...
namespace glasssix::exposing::nessus::Service
{
	class S_Pedestrian :public Service {
		...
		static constexpr utf8_string_view MODULE_{ u8"pedestrian" };
		static constexpr utf8_string_view NEW_{ u8"pedestrian.new" };
		static constexpr utf8_string_view DELETE_{ u8"pedestrian.delete" };
		static constexpr utf8_string_view VERSION_{ u8"pedestrian.version" };
		static constexpr utf8_string_view detect_{ u8"pedestrian.detect" };
	public:
