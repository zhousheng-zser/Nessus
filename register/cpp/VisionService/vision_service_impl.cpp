...
namespace glasssix::exposing::nessus
{
	...
	public:
		...
		unknown_object pedestrian_new(const param_hash_map<param_string, unknown_object>& params)
		{
			...
			return add_instance(package_names::pedestrian, make_exported_interface<glasssix::pedestrian::classify_code>(models_directory, device));
		}
	...
	private:
		...
		unknown_object pedestrian_detect(const param_hash_map<param_string, unknown_object>& params)
		{
			...
			auto instance = get_instance<pedestrian::classify_code>(params);
