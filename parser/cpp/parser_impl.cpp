...
namespace glasssix::exposing::nessus
{
	...
	std::unordered_map<std::string, std::function<Json::Value(plugin_interface&, Json::Value&, param_span<std::uint8_t>&, guid&, param_span<std::uint8_t>&)>> parser_impl::impl::basic_protocol_map = [] {
...
#endif	
		protocol_map["cthulhu.new"] = &Cthulhu_new_json;
		protocol_map["cthulhu.delete"] = &Cthulhu_delete_json;
		protocol_map["cthulhu.detect"] = &Cthulhu_detect_json;
		protocol_map["cthulhu.version"] = &Cthulhu_version_json;
		...
		protocol_map["pedestrian_labor.new"] = &Pedestrian_labor_new_json;
		protocol_map["pedestrian_labor.delete"] = &Pedestrian_labor_delete_json;
		protocol_map["pedestrian_labor.detect"] = &Pedestrian_labor_detect_json;
		protocol_map["pedestrian_labor.version"] = &Pedestrian_labor_version_json;
