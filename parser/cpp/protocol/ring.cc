...
#include <ring/box_info.hpp>

namespace glasssix::exposing::nessus::Protocol {

	class P_Ring : public Protocol
	{
		static Json::Value Ring_version_json(plugin_interface& plugin, Json::Value& root, param_span<std::uint8_t>& data, guid& instance, param_span<std::uint8_t>& external)
		{
			Json::Value value;
			try
			{
				...
				auto version = plugin.execute(u8"ring.version", param);
		...
		static Json::Value Ring_new_json(plugin_interface& plugin, Json::Value& root, param_span<std::uint8_t>& data, guid& instance, param_span<std::uint8_t>& external)
		{
			Json::Value value;
		...
		static Json::Value Ring_delete_json(plugin_interface& plugin, Json::Value& root, param_span<std::uint8_t>& data, guid& instance, param_span<std::uint8_t>& external)
		{
			Json::Value value;
			try
			{
		...
		static Json::Value Ring_detect_json(plugin_interface& plugin, Json::Value& root, param_span<std::uint8_t>& data, guid& instance, param_span<std::uint8_t>& external)
		{
			Json::Value value;
			try
			{
	...
	public:
		virtual const std::unordered_map<std::string, protocol_function> parser_protocol_dump() const override {
			...
			protocol_map["ring.version"] = &Ring_version_json;
